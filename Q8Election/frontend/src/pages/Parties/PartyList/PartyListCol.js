...
const Id = (cellProps) => {
  return (
    <Link
      to={`/dashboard/party/${cellProps.row.original.id}`}
...
const Name = (cellProps) => (
  <AvatarList {...cellProps} dirName="parties" />
);
  ...
  return (
    <React.Fragment>
      <div className="d-flex">
        <div className="flex-grow-1 parties_name">{cell.value}</div>
