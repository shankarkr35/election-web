...
import { getCandidateDetails, updateCandidate } from "../../../store/actions";
...
const EditTab = ({ candidate }) => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      image: candidate.image ? `${MEDIA_URL}${candidate.image}` : "",
    ...
    onSubmit: (values) => {
      ...
      dispatch(
        updateCandidate({ candidate: updatedElection, formData: formData })
      );
    },
  });
  ...
  document.title =
    "Update Candidate | Q8Tasweet - React Admin & Dashboard Template";
        ...
        <Row>
          ...
          <Col lg={7}>
            <Card>
              ...
              <CardBody>
                ...
                <div className="mb-3">
                  <Label className="form-label">Candidate Description</Label>
                  <CKEditor
                    name="description"
          ...
          <Col lg={3}>
            <Card>
              ...
              <CardBody>
                <div className="mb-3">
                  <Label for="candidate-type" className="form-label">
                    Candidate Type
                  </Label>
                  <Input
                    name="type"
