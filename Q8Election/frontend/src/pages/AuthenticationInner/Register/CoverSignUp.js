...
const CoverSignUp = () => {
    document.title = "Cover SignUp | Q8Tasweet - React Admin & Dashboard Template";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Free Q8Tasweet account now.</p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <Form onSubmit={validation.handleSubmit} className="needs-validation" noValidate action="index">
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Q8Tasweet <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Q8Tasweet. Crafted with <i className="mdi mdi-heart text-danger"></i> by Q8Vision</p>
                                </div>
                            </div>
                        </div>
                    </Container>
