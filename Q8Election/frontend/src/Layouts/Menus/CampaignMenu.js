  ...
  const createMenuItem = (campaign) => [
    {
      ...
      subItems: [
        {
          id: "campaign", // You can use a unique identifier here
          label: "الحملة الإنتخابية", // Display campaign name
          icon: "ri-honour-line",
          link: `/dashboard/campaigns/${campaign.slug}`, // Link to campaign details
          click: function (e) {
            e.preventDefault();
